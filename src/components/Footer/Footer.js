    ...
    <div>
        ...
        <div>
            <ul>
                ...
                <li>Удалять данные о машинах (пока не работает)</li>
                <li>Добавлять данные о заправках и прочих расходах</li>
                <li>
                    Редактировать данные о заправках и прочих расходах (пока не
                    работает)
                </li>
                <li>
                    Удалять данные о заправках и прочих расходах (пока не
                    работает)
                </li>
                <li>
